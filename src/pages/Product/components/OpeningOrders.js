    ...
    return (
        <StyledWrapper className={props.className} style={props.style}>
            <div className='card-text'>
                <h4>Opening Orders</h4>
                <p>There are {numOrders} orders waiting for purchase</p>
                <Button type='primary' onClick={modal.show}>Show List</Button>
            </div>
